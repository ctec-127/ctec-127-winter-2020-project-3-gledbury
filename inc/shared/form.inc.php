...
<!-- <form action="<?php echo $where?>" method="POST"> -->
    ...
    <input class="form-control" type="text" id="student_id" name="student_id" placeholder="Enter student ID here" value="<?= (isset($sid) ? $sid : '') ?>">
    <br>
    ...
    <input class="form-control" type="tel" id="phone" name="phone" placeholder="Phone number 000-000-0000" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" value="<?php echo (isset($phone) ? $phone : ''); ?>">
    <br>
    ...
    <input class="form-control" type="number" step="0.1" max="4" id="gpa" name="gpa" placeholder="Enter gpa here" value="<?php echo (isset($gpa) ? $gpa : ''); ?>">
